      ...
      <div className="mt-4 mx-auto flex grow flex-col gap-4 md:flex-row w-4/5">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20 ">
          <p className={`${bebas.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Pagina de Admin</strong>
            , panel de administracion de la aplicacion
          </p>
          <a 
            href="#"
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          <img src="/repsol-grifo.jpeg" alt="Screenshots of the grifo" width={1000} height={700} className="hidden md:block " />
          <img src="/repsol-grifo.jpeg" alt="Screenshots of the grifo" width={560} height={620} className="block md:hidden" />
